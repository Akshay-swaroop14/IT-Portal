...
// function TechStack() {
//   const tech = ['Angular','React', 'Node.js', 'MongoDB', 'Express.js', 'AWS', 'Docker', 'GitHub', 'Wordpress', 'Postman'];
...
//         {tech.map((item, index) => (
//           <div key={index} style={styles.badge}>{item}</div>
//         ))}
//       </div>
//     </div>
//   );
...
function TechStack() {
  ...
  const styles = {
    ...
    overlay: {
      ...
      height: '100%',
      width: '100%',
      backgroundColor: 'rgba(255, 255, 255, 0.75)', // semi-transparent for readability
      zIndex: 1,
    },
    content: {
      position: 'relative',
